...
';  error_log($pageno);  ?>
<caption class="pagination"><a href="?pageno=1">Aktuellste</a> | <?php if($pageno <= 1){ echo "&lt;&lt; 10"; } else { echo "<a href=?pageno=".($pageno - 1).">&lt;&lt; 10</a>";} ?>| <?php if($pageno <= 1){ echo '<span>10 &gt; &gt; ></span>'; } else { echo "<a href=?pageno=".($pageno + 1)."10 &gt; &gt;</a>"; ?> | <a href="?pageno=<?php echo $total_pages; ?>">&Auml;lteste</a></caption>
